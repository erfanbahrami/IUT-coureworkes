...
else
{
 printf("\rno function\r");
  ...
  part3=0 ;
  part4=1;
 printf("\rpart 3 is ending\r"); 
  printf("\r part 4 is running\r"); 
}
...
printf(" part 1 and prat 2 is running \r");
gets(name,13);   
printf("\r(%s)\r",name);

printf("\r part 1 and part 2 is ending \r");
part3=1;
printf("\rpart 3 is running\r");
