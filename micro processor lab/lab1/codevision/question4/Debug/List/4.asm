...
; 0000 001D       unsigned char counter = 0;
; 0000 001E       char array[] = {  0b00111111,      // 9  7_segment
...
; 0000 0028                         };
; 0000 0029 
; 0000 002A       PORTD.0 = 0;PORTD.1 = 0;PORTD.2 = 0;PORTD.3 = 0;
	SBIW R28,10
	LDI  R24,10
	LDI  R26,LOW(0)
	LDI  R27,HIGH(0)
...
; 0000 004B DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(15)
	OUT  0x11,R30
; 0000 004C // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
