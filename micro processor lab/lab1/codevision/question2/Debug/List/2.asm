...
; 0000 001E         //3000/8=375
; 0000 001F       PORTB.0 = 1;delay_ms(375);PORTB.0 = 0;
	SBI  0x18,0
	RCALL SUBOPT_0x0
	CBI  0x18,0
; 0000 0020 
; 0000 0021       PORTB.1 = 1;delay_ms(375);PORTB.1 = 0;
	SBI  0x18,1
	RCALL SUBOPT_0x0
	CBI  0x18,1
; 0000 0022 
; 0000 0023       PORTB.2 = 1;delay_ms(375);PORTB.2 = 0;
	SBI  0x18,2
	RCALL SUBOPT_0x0
	CBI  0x18,2
; 0000 0024 
; 0000 0025       PORTB.3 = 1;delay_ms(375);PORTB.3 = 0;
	SBI  0x18,3
	RCALL SUBOPT_0x0
	CBI  0x18,3
; 0000 0026 
; 0000 0027       PORTB.4 = 1;delay_ms(375);PORTB.4 = 0;
	SBI  0x18,4
	RCALL SUBOPT_0x0
	CBI  0x18,4
; 0000 0028 
; 0000 0029       PORTB.5 = 1;delay_ms(375);PORTB.5 = 0;
	SBI  0x18,5
	RCALL SUBOPT_0x0
	CBI  0x18,5
; 0000 002A 
; 0000 002B       PORTB.6 = 1;delay_ms(375);PORTB.6 = 0;
	SBI  0x18,6
	RCALL SUBOPT_0x0
	CBI  0x18,6
; 0000 002C 
; 0000 002D       PORTB.7 = 1;delay_ms(375);PORTB.7 = 0;
	SBI  0x18,7
	RCALL SUBOPT_0x0
	CBI  0x18,7
; 0000 002E }
