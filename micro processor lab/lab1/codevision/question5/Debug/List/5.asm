...
; 0000 0033                         };
; 0000 0034       int number = 0 , counter = 0;
...
_0x4:
	...
	RJMP _0x6
; 0000 003A       {
; 0000 003B             a0 = number % 10;
	MOVW R26,R16
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __MODW21
	MOVW R20,R30
; 0000 003C             b0 = number / 10;
	MOVW R26,R16
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
	CALL __DIVW21
...
; 0000 0045             b3 = b2 / 10;
	...
	STD  Y+6+1,R31
; 0000 0046 
; 0000 0047             PORTC = arr[a3];
	LDD  R30,Y+14
	LDD  R31,Y+14+1
	RCALL SUBOPT_0x2
; 0000 0048             PORTD = 0b00001110; delay_ms(5);  PORTD = 0b00001111;
	LDI  R30,LOW(14)
	RCALL SUBOPT_0x3
; 0000 0049 
; 0000 004A             PORTC = arr[a2];
	LDD  R30,Y+16
	LDD  R31,Y+16+1
	RCALL SUBOPT_0x2
; 0000 004B             PORTD = 0b00001101; delay_ms(5);  PORTD = 0b00001111;
	LDI  R30,LOW(13)
	RCALL SUBOPT_0x3
; 0000 004C 
; 0000 004D             PORTC = arr2[a1];
	LDD  R30,Y+18
	LDD  R31,Y+18+1
	MOVW R26,R28
	ADIW R26,20
	...
	LD   R30,X
	OUT  0x15,R30
; 0000 004E             PORTD = 0b00001011; delay_ms(5);  PORTD = 0b00001111;
	LDI  R30,LOW(11)
	RCALL SUBOPT_0x3
; 0000 004F 
; 0000 0050             PORTC = arr[a0];
	MOVW R26,R28
	ADIW R26,30
	ADD  R26,R20
	ADC  R27,R21
	LD   R30,X
	OUT  0x15,R30
; 0000 0051             PORTD = 0b00000111; delay_ms(5);  PORTD = 0b00001111;
	LDI  R30,LOW(7)
	RCALL SUBOPT_0x3
; 0000 0052 
; 0000 0053             counter = counter + 1;
	__ADDWRN 18,19,1
; 0000 0054             if (counter == 20)
	LDI  R30,LOW(20)
	LDI  R31,HIGH(20)
	CP   R30,R18
	CPC  R31,R19
...
; 0000 006F DDRC=(1<<DDC7) | (1<<DDC6) | (1<<DDC5) | (1<<DDC4) | (1<<DDC3) | (1<<DDC2) | (1<<DDC1) | (1<<DDC0);
	LDI  R30,LOW(255)
	OUT  0x14,R30
...
; 0000 0075 DDRD=(0<<DDD7) | (0<<DDD6) | (0<<DDD5) | (0<<DDD4) | (1<<DDD3) | (1<<DDD2) | (1<<DDD1) | (1<<DDD0);
	LDI  R30,LOW(15)
	OUT  0x11,R30
; 0000 0076 // State: Bit7=T Bit6=T Bit5=T Bit4=T Bit3=0 Bit2=0 Bit1=0 Bit0=0
