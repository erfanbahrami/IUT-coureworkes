...
; 0000 0023         char string[] = "Welcome to the online lab classes due to Corona disease.";
; 0000 0024         char show[16];
; 0000 0025          //  char show2[] = "---------------";
; 0000 0026         int counter = 0;
...
;	counter -> R16,R17
	...
	LDI  R27,HIGH(500)
	CALL _delay_ms
; 0000 0028         for(counter = 0; counter<strlen(string); counter++)
	__GETWRN 16,17,0
_0x5:
	MOVW R26,R28
	ADIW R26,18
...
; 0000 002A             lcd_gotoxy(0, 1);
	...
	LDI  R26,LOW(1)
	CALL _lcd_gotoxy
; 0000 002B             strncpy(show, &string[counter], 16);
	MOVW R30,R28
	ADIW R30,2
	ST   -Y,R31
	ST   -Y,R30
...
; 0000 002D          //   lcd_puts(show2);
; 0000 002E             lcd_puts(show);
	MOVW R26,R28
	ADIW R26,2
	CALL _lcd_puts
