...
_0x0:
	...
	.DB  0x32,0x34,0x35,0x31,0x33,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0021       lcd_gotoxy(0, 0);
	...
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 0022       lcd_puts("Erfan Bahrami");
	__POINTW2MN _0x3,0
	RCALL _lcd_puts
...
; 0000 004C // D4 - PORTA Bit 4
; 0000 004D // D5 - PORTA Bit 5
; 0000 004E // D6 - PORTA Bit 6
; 0000 004F // D7 - PORTA Bit 7
